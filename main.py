...
def fetch_team_form(team_id):
    try:
        ...
        avg_goals = goals_scored / 5 if matches else 1.2
...
def poisson_scores(avg_home, avg_away):
    ...
    for h in range(4):
        for a in range(4):
            prob = (math.exp(-avg_home) * avg_home ** h / math.factorial(h)) * \
                   (math.exp(-avg_away) * avg_away ** a / math.factorial(a))
        ...
        for match in matches:
            ...
            if analysis:
                ...
                try:
                    ...
                    pass
        time.sleep(300)  # 5-minute update
...
if __name__ == "__main__":
    print("⚽ Malik Bhai Intelligent Bot running (polling mode)")
